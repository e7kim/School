...
public class Lab0_EK 
{
	...
	public static void main(String[] args) 
	{
		...
		do
		{
			...
			if(option == 1)
				...
				System.out.println(averageNumberOfSteps(bridgeLength, (bridgeLength + 1)/2, numberOfTrials) + " Steps");
			else if(option == 3)
				System.out.println(averageNumberOfSteps(bridgeLength, (bridgeLength + 1)/2, numberOfTrials) * numberOfTrials + " Steps");
			else if(option == 4)
	...
	public static double averageNumberOfSteps(int length, int pos, int trials)
	{
		int[] numberOfTrials = new int[trials];
		for(int i = 0; i < trials; i++)
			numberOfTrials[i] = countSteps(length, pos);
