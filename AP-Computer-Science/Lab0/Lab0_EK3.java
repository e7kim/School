...
public class Lab0_EK 
{
	...
	public static void main(String[] args) 
	{
		...
		do
		{
			...
			{
				System.out.println(averageNumberOfSteps(bridgeLength, (bridgeLength + 1)/2, 0, numberOfTrials) + " Steps");
			}
			else if(option == 3)
			{
				System.out.println(averageNumberOfSteps(bridgeLength, (bridgeLength + 1)/2, 0, numberOfTrials) * numberOfTrials + " Steps");
			}
			else if(option == 4)
			{
	...
	public static void findMaxAndMin(int w, int x, int y, int z)
	{
		...
		for(int j = 0; j < z; j++)
		{
			if(numberOfTrials[j] < minimum)
			{
				minimum = numberOfTrials[j];
			}
		}
